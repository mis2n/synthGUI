...
def Window():
    ...
    check = tk.Button(pad, font = myFont, text = "Check", fg = "black", bg = "gray", command = Check)
    check.grid(row=7, column=3)
    
    M1 = tk.Label(pad, font = myFont, text = "       Click on the synthetic images, then the 'CHECK' button", fg = "black")
    M1.grid(row=1, column=6)
    
    M2 = tk.Label(pad, font = myFont, text = "       Our experts were 55.14% accurate on average ", fg = "black")
    M2.grid(row=3, column=6)
    
    M3 = tk.Label(pad, font = myFont, text = "       How well can you do?", fg = "black")
    M3.grid(row=5, column=6)
